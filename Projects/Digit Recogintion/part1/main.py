...
#     print('softmax test_error mod3 =', test_error_mod3)
#     return test_error


# # print('softmax test_error= ', run_softmax_on_MNIST(temp_parameter=0.5), 'temp_parameter= 0.5')
# print('softmax test_error= ', run_softmax_on_MNIST(temp_parameter=1), 'temp_parameter= 1')
# # print('softmax test_error= ', run_softmax_on_MNIST(temp_parameter=2), 'temp_parameter= 2')
...
#     print('softmax test_error mod3 =', test_error)
#     return test_error
...
# # TODO: Use the sklearn package and build the SVM model on your local machine. Use random_state = 0, kernel = 'poly', degree = 3
# pred_test_y = multi_class_svm_cube(train_pca10, train_y, test_pca10)
# test_error = compute_test_error_svm(test_y, pred_test_y)
# print('SVM PCA10 Poly3 test_error=', test_error)


# # TODO: Train your softmax regression model using (train_pca10, train_y) on svm model on rbf
pred_test_y = multi_class_svm_rbf(train_pca10, train_y, test_pca10)
test_error = compute_test_error_svm(test_y, pred_test_y)
print('SVM PCA10 RBF test_error=', test_error)