...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        outpur_derivative_vec = np.vectorize(output_layer_activation_derivative)
        hidden_layer_error = self.hidden_to_output_weights.T.dot(output_layer_error) * outpur_derivative_vec(output)
